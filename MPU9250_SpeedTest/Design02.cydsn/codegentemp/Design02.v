...
module top ;
	...
	wire [0:0] tmpOE__MOSI_SDA_net;
	wire [0:0] tmpFB_0__MOSI_SDA_net;
	wire [0:0] tmpIO_0__MOSI_SDA_net;
	wire [0:0] tmpINTERRUPT_0__MOSI_SDA_net;
	electrical [0:0] tmpSIOVREF__MOSI_SDA_net;
	...
	cy_psoc3_pins_v1_10
		...
		MOSI_SDA
		 (.oe(tmpOE__MOSI_SDA_net),
		  .y({Net_2}),
		  .fb({tmpFB_0__MOSI_SDA_net[0:0]}),
		  .io({tmpIO_0__MOSI_SDA_net[0:0]}),
		  .siovref(tmpSIOVREF__MOSI_SDA_net),
		  .interrupt({tmpINTERRUPT_0__MOSI_SDA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MOSI_SDA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__MISO_SDO_net;
	wire [0:0] tmpIO_0__MISO_SDO_net;
	wire [0:0] tmpINTERRUPT_0__MISO_SDO_net;
	electrical [0:0] tmpSIOVREF__MISO_SDO_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		MISO_SDO
		 (.oe(tmpOE__MISO_SDO_net),
		  .y({1'b0}),
		  .fb({Net_14}),
		  .io({tmpIO_0__MISO_SDO_net[0:0]}),
		  .siovref(tmpSIOVREF__MISO_SDO_net),
		  .interrupt({tmpINTERRUPT_0__MISO_SDO_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MISO_SDO_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    SPI_Master_v2_50_0 SPI_IMU (
        .clock(1'b0),
        .miso(Net_14),
        .mosi(Net_2),
        .reset(Net_1),
        .rx_interrupt(Net_186),
        .sclk(Net_3),
        .sdat(Net_187),
        .ss(Net_390),
    ...
    assign Net_383 = Net_390 | Net_416;
    ...
    defparam Control_Reg_1.BitValue = 3;
    defparam Control_Reg_1.BusDisplay = 0;
    defparam Control_Reg_1.ExtrReset = 0;
    defparam Control_Reg_1.NumOutputs = 2;

	wire [0:0] tmpOE__ChipSelect_1_net;
	wire [0:0] tmpFB_0__ChipSelect_1_net;
	wire [0:0] tmpIO_0__ChipSelect_1_net;
	wire [0:0] tmpINTERRUPT_0__ChipSelect_1_net;
	electrical [0:0] tmpSIOVREF__ChipSelect_1_net;

	cy_psoc3_pins_v1_10
		#(.id("66d1fb21-f3d0-457e-9bcd-14b2c8e3cb50"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ChipSelect_1
		 (.oe(tmpOE__ChipSelect_1_net),
		  .y({Net_383}),
		  .fb({tmpFB_0__ChipSelect_1_net[0:0]}),
		  .io({tmpIO_0__ChipSelect_1_net[0:0]}),
		  .siovref(tmpSIOVREF__ChipSelect_1_net),
		  .interrupt({tmpINTERRUPT_0__ChipSelect_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ChipSelect_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ChipSelect_2_net;
	wire [0:0] tmpFB_0__ChipSelect_2_net;
	wire [0:0] tmpIO_0__ChipSelect_2_net;
	wire [0:0] tmpINTERRUPT_0__ChipSelect_2_net;
	electrical [0:0] tmpSIOVREF__ChipSelect_2_net;

	cy_psoc3_pins_v1_10
		#(.id("a65eaaa0-3b71-46d3-8d8e-aeabc56937e2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ChipSelect_2
		 (.oe(tmpOE__ChipSelect_2_net),
		  .y({Net_386}),
		  .fb({tmpFB_0__ChipSelect_2_net[0:0]}),
		  .io({tmpIO_0__ChipSelect_2_net[0:0]}),
		  .siovref(tmpSIOVREF__ChipSelect_2_net),
		  .interrupt({tmpINTERRUPT_0__ChipSelect_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ChipSelect_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_386 = Net_390 | Net_452;
